...
module.exports = {
    up: async (queryInterface, Sequelize) => {
        ...
        await queryInterface.sequelize.query(
            `ALTER TYPE "enum_CCCChanges_reason" ADD VALUE 'validator' AFTER 'deposit'`
        );
        await Promise.all([
    ...
    down: async (queryInterface, Sequelize) => {
        ...
        await queryInterface.sequelize.query(
            `CREATE TYPE "enum_CCCChanges_reason" AS ENUM ('fee', 'author', 'stake', 'tx', 'initial_distribution', 'deposit')`
        );
        await queryInterface.sequelize.query(
